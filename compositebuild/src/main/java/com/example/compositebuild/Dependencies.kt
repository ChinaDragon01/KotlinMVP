...
//    const val lifecycle_viewmodel_ktx = "androidx.lifecycle:lifecycle-viewmodel-ktx:${Versions.lifecycleVersion}"
    ...
    const val room_ktx = "androidx.room:room-compiler:${Versions.room_ktx}"// https://developer.android.com/kotlin/ktx?hl=zh-cn
    const val room_runtime = "androidx.room:room-runtime:${Versions.room_version}"//https://developer.android.com/training/data-storage/room?hl=zh-cn#kts
...
//    const val live_event_bus = "io.github.jeremyliao:live-event-bus-x:${Versions.live_event_bus_x}"//https://github.com/JeremyLiao/LiveEventBus
